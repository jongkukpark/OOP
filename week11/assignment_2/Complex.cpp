...
Number *Complex::add(Number * num) {
	...
	if (num->types() == INTEGER) {
		...
		this->set_val(this->real() + newNum->val(), this->imag());
		delete(newNum);
		return this;
		...
		newNum->set_val(this->real() + newNum->real(), this->imag() + newNum->imag());
		delete(this);
		return newNum;
    } else {
...
Number *Complex::mul(Number * num) {
	...
	if (num->types() == INTEGER) {
		...
		Complex* newNum = dynamic_cast<Complex*>(num);
		newNum->set_val((this->real() * newNum->real()) - (this->imag() * newNum->imag()), (this->real() * newNum->imag()) + (this->imag() * newNum->real()));
		delete(this);
		return newNum;
    } else {
